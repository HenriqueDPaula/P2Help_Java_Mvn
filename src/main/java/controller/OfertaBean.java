...
public class OfertaBean implements Serializable {
	...
	public String cadastrar() {
		...
		try {
			...
			e.printStackTrace();
			Util.mensagemErro("Não foi possivel cadastrar!");
			//FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "Erro, nÃ£o foi possivel cadastrar a oferta", " "));
	...
	public String atualizarConfirm() {
		...
		try {
			...
			//FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "Erro, nÃ£o foi possivel atualizar a oferta", " "));
		}
	...
	public void cadastrarSistema() {
		...
		try {
			...
			//FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "Houve um erro, sistema nÃ£o cadastrado", " "));
		}
